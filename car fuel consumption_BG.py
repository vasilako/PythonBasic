...
precioCombustible = float(input("Цента нагоривото за литър_: "))
elegirCaclculo = int(input("Натисни едно за да изчислиш разхода за 100 Км /n, натисни 2 за да изчислиш стойноста на километър"))


#------------------Condicional eleccion de la funcion--------------------

if elegirCaclculo == 1:
        print("Разхода е: ", calculoConsomo(litros, kilomertosTrascutidos), "на 100 Km")
...
#----------v.1-1------LLAMADA A LA PRIMERA FUNCION costePorKilometro(calculoConsomo(litros, kilomertosTrascutidos), precioCombustible)--------------    
     ...
     print("Стойноста на иминат километър е: ", costePorKilometro(calculoConsomo(litros, kilomertosTrascutidos), precioCombustible), "Лв")
